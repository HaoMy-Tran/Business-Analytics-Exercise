...
LEFT JOIN (
  SELECT 
    ...
    SUM(CASE WHEN oi.delivered_at >= '2025-10-01' and oi.delivered_at <= '2025-12-31' THEN sale_price ELSE 0 END) Q42025_revenue,
    SUM(CASE WHEN oi.delivered_at >= '2026-01-01' and oi.delivered_at <= '2026-03-31' THEN sale_price ELSE 0 END) Q12026_revenue
